    ...
    <div className="bg-white p-6 rounded-3xl border shadow-xl max-w-lg mx-auto">
      ...
      <div className="space-y-4">
        ...
        <button 
          ...
          className="w-full bg-emerald-950 text-white py-4 rounded-xl font-black uppercase text-sm shadow-lg active:scale-95 mt-4"
        >
          Registra Gruppo
        </button>
      </div>
