...
export default function App() {
  ...
  // FILTRO DI SICUREZZA PER LO 0 (Conta solo se ha un nome)
  ...
  if (loading) return <div className="min-h-screen flex items-center justify-center font-black text-emerald-800 bg-stone-50 italic animate-pulse">CARICAMENTO...</div>;
                            ...
                            {specTrans.sort((a,b) => b.date.localeCompare(a.date)).map(t => (
                                <div key={t.id} className="flex justify-between items-center p-3 bg-stone-50 rounded-xl group hover:bg-white transition">
                                    <div className="flex items-center gap-3">
                                      <div className={t.type === 'Entrata' ? 'text-emerald-500' : 'text-red-500'}>{t.type === 'Entrata' ? <ArrowUpRight size={16}/> : <ArrowDownLeft size={16}/>}</div>
